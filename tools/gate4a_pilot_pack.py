...
def create_derived_status(
    ...
    return {
        ...
        "statement": "NO INTERPRETATION. NO SCIENTIFIC CLAIMS. PACKAGING + STRUCTURAL VALIDATION ONLY."
    }
    ...
    return {
        ...
        "@graph": [
            ...
            },
            {
                ...
                "description": "Deterministic lab execution pilot (structural validation only, non-interpretive)",
